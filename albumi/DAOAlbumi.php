...
class DAOAlbumi
{
    ...
    private $GETALLALBUMIANDAUTORI = "SELECT alb.id AS id, aut.id AS aut_id, alb.naziv AS naziv, aut.ime AS ime, aut.prezime AS prezime FROM albumi alb JOIN autori aut ON aut.id = alb.autor_id";
