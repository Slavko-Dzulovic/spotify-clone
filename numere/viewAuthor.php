          ...
          <ul class="list-group " id="lista">
            ...
            <div class="album">
              <li class="list-group-item  album-list"><img
                  ...
                  alt="" width="100px" height="100px"><?php echo $album['album_naziv']; ?></li>
                  ...
                  <?php foreach ($numere as $numera) {
                    ...
                    <tr>
                      ...
                      <td colspan="2"><?php echo $numera['naziv']; ?></td>
                        <td><button id="play-button" onclick='setNewSong(<?php echo json_encode($numera, JSON_PRETTY_PRINT); ?>)'><i class="fas fa-play"></i></button>
                        <i class="fas fa-heart"></i>
                            <a href="<?php echo $numera['ref_fajla']; ?>" download="<?php echo $numera['naziv']; ?>" target="_blank"><i class="fas fa-arrow-down"></i></a>
                      </td>
                    </tr>
                  <?php }} ?>
                  </tbody>
...
<?php } else { header("Location:../numere/?action=dash"); }?>