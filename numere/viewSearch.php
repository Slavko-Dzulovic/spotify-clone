...
if (isset($_SESSION['loggedIn'])) {
    ...
    <div class="menu" id="menu">
        ...
        <a href="../numere/?action=gotoPlaylist&playlist_id=<?php echo $favPlejlista['id']; ?>"><i
                    ...
                    <?php foreach ($plejliste as $plejlista) { ?>
                        <div class="card" style="width:300px">
                            <img class="card-img-top" src="<?php echo $plejlista['ref_slika']; ?>" alt="Card image"
                                 style="width:100%; height: 60%;">
                            <div class="card-body">
                                <a href="../numere/?action=gotoPlaylist&playlist_id=<?php echo $plejlista['playlist_id']; ?>">
                                    <h4 class="card-title"><?php echo $plejlista['naziv']; ?></h4></a>
                ...
                <div class="glider g3">
                    <?php foreach ($numere as $numera) { ?>
                        <div class="card" style="width:300px">
                            ...
                            <div class="card-body">
                                <a class="title-card"
                                   href="../numere/?action=gotoAuthor&autorId=<?php echo $numera['autor_id']; ?>"
                                   onclick='addToQueueOneSong(<?php echo json_encode($numera, JSON_PRETTY_PRINT); ?>)'>
                                    <h4
